 ...
 with mp_pose.Pose(min_detection_confidence=0.8, min_tracking_confidence=0.5) as pose:
    while cap.isOpened():
        ...
        try:
            ...
            # Calculate angle
            round_angle = calculate_angle(Left_Shoulder,Left_Hip, Left_Knee)
            round_angle2 = calculate_angle(Right_Shoulder,Right_Hip, Right_Knee)
            ...
            if round_angle >= 160:
                stage = "up"
            if round_angle <= 50 and stage =='up':
            ...
            if round_angle2 >= 160:
                stage = "up"
            if round_angle2 <= 50 and stage =='up':
