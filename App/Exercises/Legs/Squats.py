...
from Rep_SoundEffects.Play_Rep_Sound import Rep_One, Rep_Two, Rep_Three, Rep_Four, Rep_Twelve, Rep_Eleven, Rep_Five, Rep_Six, Rep_Seven, Rep_Eight, Rep_Nine, Rep_Ten
...
def Squats():
 ...
 #Rep_Amount_Selector = st.selectbox(label="Select the Amount reps of you would like to do", options= ['1', '2', '3', '4', '5'])
