...
from Rep_SoundEffects.Play_Rep_Sound import Rep_One, Rep_Two, Rep_Three, Rep_Four,Rep_Eleven, Rep_Twelve, Rep_Five, Rep_Six, Rep_Seven, Rep_Eight, Rep_Nine, Rep_Ten
    ...
    while cap.isOpened():
        ...
        try:
           ...
           """
            ...
            if round_angle >= 95:
                stage = "up"
            if round_angle <= 45 and stage =='up':
                stage="down"
                counter +=1
                print(counter)
            ...
            if round_angle2 >= 95:
                stage = "up"
            if round_angle2 <= 45 and stage =='up':
                stage="down"
                counter +=1
                print(counter)
...
if __name__ == '__ArnoldShoulderPress__':
   ArnoldShoulderPress()