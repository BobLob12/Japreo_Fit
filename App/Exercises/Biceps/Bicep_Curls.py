...
import numpy as np
import time
from Rep_SoundEffects.Play_Rep_Sound import Rep_One, Rep_Two, Rep_Three, Rep_Four, Rep_Five, Rep_Six, Rep_Seven, Rep_Eight, Rep_Nine, Rep_Ten, Rep_Twelve, Rep_Eleven
 ...
 with mp_pose.Pose(min_detection_confidence=0.8, min_tracking_confidence=0.5) as pose:
    while cap.isOpened():
        ...
        try:
            ...
            angle2 = calculate_angle(shoulder_1,elbow_1,wrist_1)
        ...
        cv2.putText(image, str('Bicep Curls' ), 
                    (10,120), 
